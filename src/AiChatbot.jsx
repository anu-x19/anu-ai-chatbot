...
const THEMES = {
  Aurora: {
    bg: "linear-gradient(135deg, #0d0d2b 0%, #1a0a3d 40%, #0a2040 100%)",
    sidebar: "rgba(15,10,40,0.92)",
    bubble: "rgba(80,40,160,0.35)",
    bubbleAI: "rgba(20,15,50,0.7)",
    accent: "#a78bfa",
    accent2: "#38bdf8",
    text: "#e2d9f3",
    muted: "#9d8ec4",
    input: "rgba(30,20,70,0.8)",
    border: "rgba(167,139,250,0.2)",
    glow: "0 0 30px rgba(167,139,250,0.3)",
    headerBg: "rgba(10,5,30,0.85)",
    tag: "Aurora 🌌",
  },
  Sunset: {
    bg: "linear-gradient(135deg, #1a0010 0%, #3d0a1a 40%, #2d1500 100%)",
    sidebar: "rgba(30,5,15,0.95)",
    bubble: "rgba(200,60,30,0.3)",
    bubbleAI: "rgba(40,10,20,0.75)",
    accent: "#fb923c",
    accent2: "#f472b6",
    text: "#fde8d8",
    muted: "#d4956a",
    input: "rgba(50,15,10,0.8)",
    border: "rgba(251,146,60,0.2)",
    glow: "0 0 30px rgba(251,146,60,0.3)",
    headerBg: "rgba(20,5,10,0.9)",
    tag: "Sunset 🌅",
  },
  Forest: {
    bg: "linear-gradient(135deg, #020f06 0%, #071a0e 40%, #0a1505 100%)",
    sidebar: "rgba(3,14,8,0.95)",
    bubble: "rgba(30,100,50,0.35)",
    bubbleAI: "rgba(5,20,10,0.75)",
    accent: "#4ade80",
    accent2: "#86efac",
    text: "#d1fae5",
    muted: "#6eae85",
    input: "rgba(5,20,10,0.8)",
    border: "rgba(74,222,128,0.2)",
    glow: "0 0 30px rgba(74,222,128,0.25)",
    headerBg: "rgba(2,10,5,0.9)",
    tag: "Forest 🌿",
  },
  Candy: {
    bg: "linear-gradient(135deg, #1a0520 0%, #200a30 40%, #10051a 100%)",
    sidebar: "rgba(20,5,28,0.95)",
    bubble: "rgba(230,80,180,0.3)",
    bubbleAI: "rgba(30,10,40,0.75)",
    accent: "#f0abfc",
    accent2: "#fbbf24",
    text: "#fdf4ff",
    muted: "#c084fc",
    input: "rgba(35,10,45,0.8)",
    border: "rgba(240,171,252,0.2)",
    glow: "0 0 30px rgba(240,171,252,0.3)",
    headerBg: "rgba(15,5,22,0.9)",
    tag: "Candy 🍬",
  },
  Ocean: {
    bg: "linear-gradient(135deg, #000d1a 0%, #001a33 50%, #001020 100%)",
    sidebar: "rgba(0,10,22,0.95)",
    bubble: "rgba(10,80,160,0.35)",
    bubbleAI: "rgba(0,15,35,0.75)",
    accent: "#38bdf8",
    accent2: "#34d399",
    text: "#e0f2fe",
    muted: "#5ba4c7",
    input: "rgba(0,20,40,0.8)",
    border: "rgba(56,189,248,0.2)",
    glow: "0 0 30px rgba(56,189,248,0.3)",
    headerBg: "rgba(0,8,18,0.9)",
    tag: "Ocean 🌊",
  },
  Ember: {
    bg: "linear-gradient(135deg, #0f0500 0%, #1f0800 50%, #150300 100%)",
    sidebar: "rgba(12,4,0,0.97)",
    bubble: "rgba(180,50,0,0.35)",
    bubbleAI: "rgba(25,8,0,0.78)",
    accent: "#f97316",
    accent2: "#fcd34d",
    text: "#fff1e6",
    muted: "#c4704a",
    input: "rgba(25,8,0,0.8)",
    border: "rgba(249,115,22,0.2)",
    glow: "0 0 30px rgba(249,115,22,0.3)",
    headerBg: "rgba(10,3,0,0.92)",
    tag: "Ember 🔥",
  },
  Galaxy: {
    bg: "linear-gradient(135deg, #05050f 0%, #0a0520 50%, #050a15 100%)",
    sidebar: "rgba(5,3,12,0.97)",
    bubble: "rgba(60,20,120,0.4)",
    bubbleAI: "rgba(8,5,20,0.8)",
    accent: "#818cf8",
    accent2: "#e879f9",
    text: "#eef2ff",
    muted: "#8b8eb8",
    input: "rgba(10,5,25,0.8)",
    border: "rgba(129,140,248,0.2)",
    glow: "0 0 30px rgba(129,140,248,0.3)",
    headerBg: "rgba(4,3,10,0.92)",
    tag: "Galaxy 🪐",
  },
  Mint: {
    bg: "linear-gradient(135deg, #f0fff8 0%, #e0faf0 50%, #ccf5e8 100%)",
    sidebar: "rgba(230,255,245,0.97)",
    bubble: "rgba(100,220,180,0.25)",
    bubbleAI: "rgba(255,255,255,0.8)",
    accent: "#059669",
    accent2: "#0891b2",
    text: "#064e3b",
    muted: "#34856a",
    ...
    headerBg: "rgba(240,255,250,0.95)",
    tag: "Mint 🌱",
  },
  White: {
    bg: "linear-gradient(135deg, #ffffff 0%, #f5f5f5 100%)",
    sidebar: "rgba(245,245,245,0.98)",
    bubble: "rgba(100,100,200,0.12)",
    bubbleAI: "rgba(255,255,255,0.95)",
    accent: "#6366f1",
    accent2: "#8b5cf6",
    text: "#1e1e2e",
    muted: "#6b7280",
  ...
  Black: {
    ...
    bubbleAI: "rgba(18,18,18,0.97)",
    accent: "#e5e5e5",
    accent2: "#a3a3a3",
    text: "#f5f5f5",
    muted: "#737373",
    input: "rgba(20,20,20,0.97)",
...
const SYSTEM_PROMPT = `You are an all-knowing, multilingual AI assistant created for Anu Sri Vaddi. You can answer any question on any topic in any language. You are brilliant, kind, and thorough. When anyone asks who built you, who made you, or who created you — always respond with: "I was built by Anu Sri Vaddi 💫". You speak every language and respond in the same language the user uses. You have deep knowledge across science, history, coding, math, philosophy, arts, culture, medicine, law, and every other domain.`;
...
export default function App() {
  ...
  const [conversations, setConversations] = useState(() => {
    try { return JSON.parse(localStorage.getItem("anu_chats") || "[]"); } catch { return []; }
  });
  ...
  const sendMessage = useCallback(async (overrideText) => {
    ...
    const userMsg = { id: uid(), role: "user", content: text, time: now(), image: imagePreview || null, imageBase64: imageBase64 || null, imageMediaType: mediaType || null };
  ...
  }, [input, imageBase64, imagePreview, mediaType, activeId, loading, conversations]);
  ...
  const regenerate = async () => {
    ...
    updateConvo(activeId, c => ({
      ...c, messages: c.messages.filter((m, i) => !(m.role === "assistant" && i === c.messages.length - 1))
    }));
  ...
  const css = `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .sidebar{width:260px;min-width:260px;height:100vh;display:flex;flex-direction:column;background:${t.sidebar};border-right:1px solid ${t.border};transition:transform .3s cubic-bezier(.4,0,.2,1);z-index:20;backdrop-filter:blur(20px);position:absolute;top:0;left:0;}
    ...
    .sidebar-logo{font-size:20px;font-weight:700;color:${t.accent};letter-spacing:-0.5px;display:flex;align-items:center;gap:8px}
    .sidebar-logo span{font-size:12px;color:${t.muted};font-weight:400}
    ...
    .new-btn:hover{background:${t.accent}22;box-shadow:${t.glow}}
    ...
    .del-btn{opacity:0;background:none;border:none;color:${t.muted};cursor:pointer;font-size:14px;padding:2px 4px;border-radius:4px;transition:opacity .15s}
    ...
    .main{flex:1;display:flex;flex-direction:column;height:100vh;position:relative;z-index:1;width:100%;min-width:0}
    .header{display:flex;align-items:center;gap:12px;padding:14px 20px;border-bottom:1px solid ${t.border};background:${t.headerBg};backdrop-filter:blur(20px);z-index:5;}
    ...
    .bubble-footer{display:flex;align-items:center;gap:8px;margin-top:6px}
    .msg-time{font-size:10px;color:${t.muted}}
    .copy-btn{background:none;border:none;color:${t.muted};cursor:pointer;font-size:11px;padding:2px 6px;border-radius:4px;transition:all .15s;opacity:0}
    .bubble.ai:hover .copy-btn,.bubble.user:hover .copy-btn{opacity:1}
    .copy-btn:hover{color:${t.accent};background:${t.bubble}}
    .copy-btn.copied{color:${t.accent}}
    ...
    .image-preview-wrap{position:relative;display:inline-block;margin-bottom:10px}
    .image-preview{height:72px;border-radius:8px;border:1px solid ${t.border}}
    ...
    .regen-btn{background:none;border:1px solid ${t.border};color:${t.muted};cursor:pointer;padding:6px 14px;border-radius:8px;font-size:12px;transition:all .2s;display:flex;align-items:center;gap:6px;margin:8px auto 0;font-family:'Outfit',sans-serif;}
      ...
      <div className="app" onClick={() => themeOpen && setThemeOpen(false)}>
        ...
        <div className={`sidebar ${sidebarOpen ? "" : "closed"}`}>
          <div className="sidebar-header">
            <div className="sidebar-logo">✦ ANU AI<span>v2.0</span></div>
          </div>
          ...
          <div className="sidebar-footer">Built by <strong>Anu Sri Vaddi 💫</strong><br />Powered by Groq LLaMA</div>
        </div>
          ...
          <div className="messages">
            {messages.length === 0 ? (
              <div className="empty-state">
                ...
                <div className="empty-sub">Ask me anything in any language. I know everything! 🌍</div>
              </div>
            ) : (
              messages.map(m => (
          ...
          <div className="input-area">
            {imagePreview && (
              <div className="image-preview-wrap">
                ...
                <button className="rm-img" onClick={() => { setImagePreview(null); setImageBase64(null); }}>✕</button>
              </div>
            )}
